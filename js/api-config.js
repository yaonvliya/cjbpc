...
var depositApiUrl = {
    //获取存管API上下文
    depositApiContext: apiHost + apiContext + "/internal/user/deposit/page_api_params",

    //获取存管API调用结果
    depositResult: apiHost + apiContext + "/internal/user/deposit/page_api_result"
};
...
var userProfileApiUrl = {
	...
	// 获取用户个人设置(get)
	getUserSettings: apiHost + apiContext +"/internal/user/settings/get",

	// 获取用户信息(get)
	getUserInfo: apiHost + apiContext +"/internal/user/account/userInfo",

	// 获取借款用户信息
	getLoanerInfo: apiHost + apiContext +"/internal/loan/user/info",
	...
	//个人开通存管
	personalOpenAccount: apiHost + apiContext +"/internal/user/deposit/personal_open_deposit",

	//企业开通存管
	companyOpenAccount: apiHost + apiContext +"/internal/user/deposit/enterprise_open_deposit",
    ...
    //用户余额查询
    balance : apiHost + apiContext + "/internal/user/deposit/user_balance",

    // 企业上传图片参数
    enterpriseUploadParam: apiHost + apiContext + "/internal/user/deposit/enterprise_upload_param",
...
var loanUserApiUrl = {
	//个人完善资料
	personalUploadInfo: apiHost + apiContext + "/internal/loan/center/personal_cert_upload",
    //企业完善资料
    companyUploadInfo: apiHost + apiContext + "/internal/loan/center/enterprise_cert_upload",
	//更新资料
	updateUploadInfo: apiHost + apiContext + "/internal/loan/center/update_cert_upload",
	//获取账户信息
    getUserAccountInfo: apiHost + apiContext + "/internal/loan/center/account_info"
...
var loanApiUrl = {
    // 判断当前用户是否具有借款资格
    checkRight: apiHost + apiContext + "/internal/loan/apply/check_right",
    //获取所属商户列表
    getMerchantList: apiHost + apiContext + "/internal/loan/apply/merchantList",
    //获取商户下产品列表
    getProductList: apiHost + apiContext + "/internal/loan/apply/productList",
    //获取产品下借款期限列表
    getLoanTermList: apiHost + apiContext + "/internal/loan/apply/loanTermList",
    //获取借款期限下子产品
    getProductItemList: apiHost + apiContext + "/internal/loan/apply/productItemList",
    //提交借款申请
    loanApply: apiHost + apiContext + "/internal/loan/apply/commit",

	//所有商户授信
    getCreditList: apiHost + apiContext + "/internal/loan/apply/creditList",
	//我的借款列表
    getApplyList: apiHost + apiContext + "/internal/loan/center/apply_list",
    //我的借款详情
    getApplyDetail: apiHost + apiContext + "/internal/loan/center/apply_detail",
    //我的还款列表
    getRepayList: apiHost + apiContext + "/internal/loan/center/to_repay_list",
	// 获取用户已还款列表
	getRepaidList: apiHost + apiContext + "/internal/loan/center/repaid_list",
    //我的还款详情
    getRepayDetail: apiHost + apiContext + "/internal/loan/center/repay_plan_detail",
	//获取还款信息
    getRepayInfo: apiHost + apiContext + "/internal/loan/common/repay_info",
    //还款
    repay: apiHost + apiContext + "/internal/loan/common/repay",
    //缴纳服务费
    payFee: apiHost + apiContext + "/internal/loan/apply/payServiceFee",
	//获取上传参数
	getUploadParam: apiHost + apiContext + "/internal/common/upload/get_upload_param",
	// 申请代偿
	applyCompensatory: apiHost + apiContext + "/internal/loan/center/apply_compensatory",
	// 撤销代偿
	cancelCompensatory: apiHost + apiContext + "/internal/loan/center/cancel_compensatory"
