layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        opt.searchSelectBtn = opt.searchSelectBtn || '选择';
        ...
        elem.off('click').on('click', function (e) {
            ...
            tableBox += '</form>';
            tableBox += '<button style="float:right;" class="layui-btn layui-btn-sm tableSelect_btn_select">' + opt.searchSelectBtn + '<span></span></button>';
            tableBox += '</div>';
            ...
            opt.table.done = function (res, curr, count) {
                res.data = res[opt.table.response.dataName];
            ...
            form.on('submit(tableSelect_btn_search)', function (data) {
                let where = {};
                Object.assign(where, opt.where, data.field);
